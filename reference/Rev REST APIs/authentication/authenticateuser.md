...
excerpt: >-
  ...
  have the same privileges and roles that user has when they login to Rev UI.
  This authentication mechanism can be used to automate Rev workflows using role
