...
When enabled, the **secondaryRTMP url** and **key** are displayed but toggling between the two streams is _not_ available through the API and can only be done through Rev's UI. 
