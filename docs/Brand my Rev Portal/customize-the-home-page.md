...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d1bd0c5-classicHomePagePreview.png",
        "classicHomePagePreview.png",
        1075
      ],
      "align": "center",
      "caption": "Preview of the Classic Home Page template with default carousels displayed"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5ea5dbd-sidebarHomePagePreview.png",
        "sidebarHomePagePreview.png",
        1151
      ],
      "align": "center",
      "caption": "Preview of the Carousels With Sidebar Home Page template with 2 sidebars selected; Channels and Events."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0af2738-homePageSideBar.png",
        "homePageSideBar.png",
        352
      ],
      "align": "center",
      "caption": "Select what items appear in the Sidebar when choosing the Carousels With Sidebar Home Page template"
    }
  ]
}
[/block]
...
> 📘 Note
> 
> The first Home Page Sidebar dropdown is **required **and may _not_ be set to **None **similar to the first carousel option.
...
- **Category** - It may not be a restricted category.
...
- One carousel is _always_ required and may not be set to None
- The same value may _not_ be set in more than one carousel
- The same category or channel may _not_ be selected for multiple carousels
