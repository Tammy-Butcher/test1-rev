...
- SP-initiated SSO
  - SSO Sign-in can be initiated from Vbrick Rev Cloud via https\://\<Vbrick_Rev_Domain>
...
1. Add Vbrick Rev Cloud from the **Okta App Catalog**.
   ...
   3. Search for **Vbrick Rev Cloud** using the search bar and click on the **Vbrick Rev Cloud** app. (<https://www.okta.com/integrations/vbrick-rev-cloud/>)
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/96ce759a21c3ffa08af34e679d8b8608219fde5caa63d2261d0803b9406aef66-setupSSO.jpg",
        "",
        ""
      ],
      "align": "center"
...
1. From your browser, navigate to the https\://\<Vbrick_Rev_Domain> sign-in page.
