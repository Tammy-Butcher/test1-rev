---
title: Disable Emails to Suspended Users
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
Admins can decide if suspended user accounts receive system email messages. By default, suspended accounts receive all system generated email.

To suspend system email messages:
