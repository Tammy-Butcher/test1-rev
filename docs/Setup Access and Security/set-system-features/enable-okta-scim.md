...
<Table align={["left","left","left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        1. Disable **LDAP Connector**.<br>  2. Install **Vbrick Rev Cloud App** in Okta.<br> 3. Configure **User and Group provisioning** in the App.<br> 4. Existing **SAML SSO** should work but you can also configure SAML SSO in the same App.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        1. Disable **LDAP Connector**. This also disables the LDAP login.<br> 2. Install the **Vbrick Rev Cloud App** in Okta.<br> 3. Configure **User and Group provisioning** in the App.<br> 4. Configure **SAML SSO** in the App.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        1. Install **Vbrick Rev Cloud App** in Okta.<br> 2. Configure **User and Group provisioning** in the App if you want automated user and group sync from Okta.<br> 3. Existing **SAML SSO** should work but you can also configure SAML SSO in the same App.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        1. Install **Vbrick Rev Cloud App** in Okta.<br> 2. Configure **User and Group Provisioning** in the App.<br> 3. Configure **SAML SSO** in the same App.
      </td>
    </tr>
  </tbody>
</Table>
