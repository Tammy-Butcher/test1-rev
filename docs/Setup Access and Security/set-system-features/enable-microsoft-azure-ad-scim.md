...
2. Click the **Enabled** checkbox next to the **Enable SCIM** setting.  Select **Azure** from the dropdown in the provider setting. You are now ready to generate your token.  Keep in mind you will need to copy and save the token and the URL that are generated in the next step.
   ...
   <Image alt="Make sure you copy the token you generate in this section" align="center" src="https://files.readme.io/8e74c36d11ffbdcb0786fbfd1e2b684779a117e3e014a0b3949c931adc1a3c8b-image.png">
...
3. Click the **Generate Token** button. **Copy** the token that is generated and then click **Ok**. Make sure you keep the copied token somewhere you can access it again.
   ...
   <Image alt="The SCIM token is needed when you configure your Azure App" align="center" width="90% " src="https://files.readme.io/6210b0cff30b2001b78a27a8e9c295694b29c09ee2ecd440e3284e67eef8a225-image.png">
     The SCIM token is needed when you configure your Azure App
   </Image>
...
4. After your token is generated, you will also need the token **Account/Tenant URL** that is now visible.  Copy it and save it as well for later use.
   ...
   <Image alt="Copy and save the tenant URL" align="center" src="https://files.readme.io/1a9351229548ff7d6dcc282d94658c667f0ad6beabbd3793206b90a6954e4647-image.png">
