...
<Image title="singleSignOn.png" alt={1173} align="center" src="https://files.readme.io/38843d0-singleSignOn.png">
  Single Sign On, No User Provisioning
</Image>
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Used to enable **Single Sign On with User Provisioning**.  This checkbox must be configured and enabled by Vbrick Support Services first before it is visible.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Paste your **Identity Provider** server’s metadata XML code in this field. You need to obtain the Identity Provider metadata (XML) from your Identity Provider server.
      </td>
    </tr>
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The email of the user account. Similar to **Identity Attribute Element Name** above, this is a required field and must be completed in order to authenticate correctly.  
