...
>
> If you are a **Vbrick Universal eCDN Customer** or **Partner**, you must *also* setup and configure your account.  View the [How to Set Up the Vbrick Universal eCDN](doc:how-to-set-up-the-vbrick-universal-ecdn) topic for details.
...
<Image align="center" src="https://files.readme.io/0ba20d0-enableJWT.png" />
