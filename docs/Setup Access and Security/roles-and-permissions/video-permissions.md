...
| LMS Exporter               | Has the ability to export packages for **Learning Management Systems (LMS)** that allow for embedding video into an LMS and sending completion events. | This is a granular form of the **Media Admin** role with the main difference being this role does _not_ manage Featured Videos or approve videos.                 |