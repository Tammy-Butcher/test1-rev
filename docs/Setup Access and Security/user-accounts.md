...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6b697d4-usersMenuDropdown.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e8e3897-assignRoleToUser.png",
        "assignRoleToUser.png",
        1075
      ],
      "align": "center",
      "caption": "The Media Viewer role is assigned by default"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "7-0": "Email",
    "7-1": "This field must be unique if used. Not required. Email address of the user account. This field must also be a correct email-format (name@subdomain.top-level-domain)",
    "8-0": "GroupNames",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/379444a-licensingStatus.png",
        "licensingStatus.png",
        911
      ],
      "align": "center",
      "caption": "The Users Module always displays licensing usage stats for your portal"
    }
  ]
}
[/block]
...
- Users are _not_ counted as [Licensed](doc:rev-license-types-and-add-ons) users until they log in and verify their account.
- **Unlicensed **and **Suspended **status states do _not_ count toward the number of Licensed users displayed.
- **Active**, **Locked Out**, **Awaiting Password Reset**, and **Awaiting Security Question Reset** _do_ count toward the number of **Licensed **users for a Rev portal.
- If a user attempts to log in to a Rev portal that does _not_ have any licenses available, the user will not be able to log in and a message is displayed to contact the Rev Account Administrator.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ff37376-awaitingPasswordResetStatus.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/77c910f-unlockUserAccount.png",
        "unlockUserAccount.png",
        596
      ],
      "align": "center",
      "caption": "If the User's account is Active or Locked Out you may reset the password or unlock the account"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/81ba47c-maxSecurityQuestionAttempts.png",
        "maxSecurityQuestionAttempts.png",
        693
      ],
      "align": "center",
      "caption": "This User has surpassed the number of attempts configured and needs Account Admin assistance"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c6acd7e-resetSecurityQuestionButton.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c7e2d23-suspendedUserStatus.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8ec824e-getUserUrl.png",
        "getUserUrl.png",
        556
      ],
      "align": "center",
