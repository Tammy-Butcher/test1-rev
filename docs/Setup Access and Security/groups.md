...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/253fa38-groupsMenuDropdown.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/58fe389-assignRoleToGroup.png",
        "assignRoleToGroup.png",
        1202
      ],
      "align": "center",
      "caption": "Each Role in the Role Assignment section will be given to Users assigned to this Group"
    }
  ]
}
[/block]
