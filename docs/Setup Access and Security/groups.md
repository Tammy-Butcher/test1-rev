...
<Image alt="The Groups Menu is accessible to Account Admins under the Users Header Navigation Menu" align="center" src="https://files.readme.io/905018fc0bc550ef40d3b5d5c20e290002f02e0c5341b4b5e95c7eaf3862295b-groupsMenu.png">
...
Keep in mind that if you have imported your group from LDAP, you may *not* add users to it from Rev. You must edit it from LDAP to add or remove users.
...
<Image title="assignRoleToGroup.png" alt={1202} align="center" src="https://files.readme.io/17cd421dbe0eee69634cf0ba1c807ad0c07b6dcfeb9da3973aed05490cc799c6-assignedGroupRoles.png">
  Each Role in the Assigned Roles section will be given to Users assigned to this Group
</Image>
...
* These accounts may be permanently deleted upon an LDAP sync by selecting **Delete Suspended Users Who have never logged in** checkbox under the **LDAP Server Synchronizations Setting** section on the LDAP Connector device. Please keep in mind that if this checkbox is enabled, the **Suspended** account deletions are permanent and only include those accounts that have *never* been logged in; *not* the manually suspended accounts through the **Users** module and described above.
