...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/905018fc0bc550ef40d3b5d5c20e290002f02e0c5341b4b5e95c7eaf3862295b-groupsMenu.png",
        null,
        "The Groups Menu is accessible to Account Admins under the Users Header Navigation Menu"
      ],
      "align": "center",
      "caption": "The Groups Menu is accessible to Account Admins under the Users Header Navigation Menu"
    }
  ]
}
[/block]
...
Keep in mind that if you have imported your group from LDAP, you may _not_ add users to it from Rev. You must edit it from LDAP to add or remove users.

Roles are assigned to a group so that specific permissions are enabled for all users assigned to the Group. Moving a Role from the **Available Roles** column to the **Assigned Roles** column adds that role (and all associated permissions) to the group while moving it back will remove it.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/17cd421dbe0eee69634cf0ba1c807ad0c07b6dcfeb9da3973aed05490cc799c6-assignedGroupRoles.png",
        "assignRoleToGroup.png",
        1202
      ],
      "align": "center",
      "caption": "Each Role in the Assigned Roles section will be given to Users assigned to this Group"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/62e86ec-assignUserToGroup.png",
        "assignUserToGroup.png",
        1095
      ],
      "align": "center",
      "caption": "Users added to the User Assignment section are added to the Group"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a4c7a78-ldapGroupList.png",
        "ldapGroupList.png",
        807
      ],
      "align": "center",
      "caption": "All groups associated with a chosen LDAP Connector (setup in the Devices menu) are displayed"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bc8e8d8-groupNameUserAssignmentLdap.png",
        "groupNameUserAssignmentLdap.png",
        806
      ],
      "align": "center",
      "caption": "You may view Group Name and User Assignment sections for an LDAP group in Rev but you must edit them in LDAP and re-import them"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8121ab4-LdapRoleAssignmentRev.png",
        "LdapRoleAssignmentRev.png",
        806
      ],
      "align": "center",
      "caption": "Role Assignment for LDAP Groups is only updated through Rev and does not change even if edited in LDAP"
    }
  ]
}
[/block]
...
- These accounts may be permanently deleted upon an LDAP sync by selecting **Delete Suspended Users Who have never logged in** checkbox under the** LDAP Server Synchronizations Setting** section on the LDAP Connector device. Please keep in mind that if this checkbox is enabled, the **Suspended **account deletions are permanent and only include those accounts that have _never_ been logged in; _not_ the manually suspended accounts through the **Users** module and described above.
