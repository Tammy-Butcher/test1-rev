...
<Image title="dmeUserLocationCloud.png" alt={722} align="center" src="https://files.readme.io/53c843b-dmeUserLocationCloud.png">
  Navigate to System Settings > eCDN Settings to configure a location services DME
</Image>
...
* Enter a valid DME URL in the **User Location Service URL** field. This must be the DME’s fully qualified domain name. Alternatively, this may also point to a load balancer that will then point to specific DMEs on your network.
  * For example, a valid URL might be: **[https://mydmename.mycompany.com/cgi-bin/localip.cgi](https://mydmename.mycompany.com/cgi-bin/localip.cgi)**\
...
* A DME customer cert does *not* need to be installed **unless you are using https**. If you *are* using https (Vbrick's recommendation), you need to install a tls certificate on the DME and follow the exact steps described above even if using on-premise Rev.
