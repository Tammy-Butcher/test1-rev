...
<Image title="customVideoFields.png" alt={1114} align="center" src="https://files.readme.io/fad24db-customVideoFields.png">
  Fields configured in the Custom Field section can be used with new video uploads
</Image>
...
<Image title="configuredCustomVideoFields.png" alt={350} align="center" src="https://files.readme.io/3f5902d-configuredCustomVideoFields.png">
  Fields added in the Custom Fields section appear in video Basic Settings for video owners to complete
</Image>
...
<Image title="customVideoFieldsBasicInfoPanel.png" alt={352} align="center" src="https://files.readme.io/6add357-customVideoFieldsBasicInfoPanel.png">
  If Publicly Displayed is enabled, the fields appear on the Video Basic Information flyout panel
</Image>
...
<Image title="customVideoFieldsIncludeinWebcasts.png" alt={502} align="center" src="https://files.readme.io/7e5ce31-customVideoFieldsIncludeinWebcasts.png">
  If Include in Webcast Event Settings is enabled, the fields appear in event Basic Settings to configure
</Image>
...
3. **Required**.  The default setting for this is no.  This tab determines whether the registration field *must* be populated/completed by the attendee before joining the webcast.
...
<Image title="customWebcastFieldsSetUp.png" alt={1059} align="center" src="https://files.readme.io/da27dcd-customWebcastFieldsSetUp.png">
  Event Admins / Hosts can select the registration fields they want to include and preview them
</Image>

Fields are arranged in the desired order by clicking and dragging.  If the field checkbox is deselected, it does not appear on the registration sign in form.  However, if the Account Admin has specified that this field is **Included in All Webcasts** when creating the custom field, the field is not able to be deselected and is *always* included.
...
<Image title="publicWebcastPreview.png" alt={811} align="center" src="https://files.readme.io/055482a-publicWebcastPreview.png">
  Required fields must be completed before a Guest can sign in to a Public webcast
</Image>
...
* The custom field may be deleted by clicking the **Delete** button. This also deletes *all* content associated with the field.
