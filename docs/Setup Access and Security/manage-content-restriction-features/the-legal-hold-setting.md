...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a4bc19e-enableLegalHold.png",
        "",
        "Enabling the Legal Hold checkbox makes this function available on the Rev portal"
      ],
      "align": "center",
      "caption": "Enabling the Legal Hold checkbox makes this function available on the Rev portal"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d9058e0-videoSettingsLegalHold.png",
        "videoSettingsLegalHold.png",
        139
      ],
      "align": "center",
      "caption": "Videos in Legal Hold are not viewable anywhere except to Account Admins"
    }
  ]
}
[/block]

When selected, a video is placed on legal hold and is no longer viewable or accessible to other users of Rev. This function is _not_ visible to any role except Account Admins.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/522ff20-legalHoldVid.png",
        "legalHoldVid.png",
        ""
      ],
      "align": "center"
