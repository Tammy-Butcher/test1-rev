...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ea4d16b-apiKeyModule.png",
        "apiKeyModule.png",
        1202
      ],
      "align": "center",
      "caption": "Click System Settings > API Keys to add a new API Key to Rev"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b28a86e-addApiKey.png",
        "addApiKey.png",
        902
      ],
      "align": "center",
      "caption": "The Add Key button adds a new key for a new device.  This should be done before you add the new device in the Device module."
    }
  ]
}
[/block]
