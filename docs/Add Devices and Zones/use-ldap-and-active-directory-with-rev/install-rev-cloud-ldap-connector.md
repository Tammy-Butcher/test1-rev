---
title: Install Rev Cloud LDAP Connector
excerpt: ''
deprecated: false
hidden: false
metadata:
...
Once the connector is installed, restart the **Vbrick Rev LDAP Connector Service** in the Window Task Manager. Complete install instructions are zipped with the file and are found [here](https://portal.vbrick.com/doc/PDFs/REV/Install%20or%20Upgrade%20the%20Vbrick%20Rev%20LDAP%20Connector.pdf).