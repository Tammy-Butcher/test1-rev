...
There are 3 steps to configure Rev so that LDAP groups are imported and synchronized. LDAP configuration _must_ be completed before you can import LDAP groups.
