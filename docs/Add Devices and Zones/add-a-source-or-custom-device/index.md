---
title: Add a Source or Custom Device
excerpt: >-
  This guide explains how to use the Source and Custom Device modules to add
  devices such as encoders for use with Rev and why you might use one over the
  other.
deprecated: false
hidden: false
metadata:
...
3. Select the device to add from the **Add a Device** dropdown.
