...
<Image title="statusColumn.png" alt={139} align="center" src="https://files.readme.io/1fc0077-statusColumn.png">
  Every Device module features a Status column
</Image>
...
<Image title="viewLogDropdown.png" alt={191} align="center" src="https://files.readme.io/3069d90-viewLogDropdown.png">
  Each module has an Actions dropdown where various actions may be taken on the Device such as viewing its log
</Image>

Device log entries are accessed by clicking **View Log** under the **Actions** dropdown of the Device.

<Image title="deviceLog.png" alt={1064} align="center" src="https://files.readme.io/0f061c5-deviceLog.png">
  Click the Show Details button to view specific details about a log line entry
</Image>
...
<Image title="requestLogsDropdown.png" alt={191} align="center" src="https://files.readme.io/2fe187a-requestLogsDropdown.png">
  The Request Logs feature is often used to assist Vbrick Support
</Image>
...
<Image title="deleteDeviceDropdown.png" alt={192} align="center" src="https://files.readme.io/b1c4cd3-deleteDeviceDropdown.png">
  Some actions are not reversible if you Delete a device.  You may also just set its status to Inactive.
</Image>
...
<Image title="rebootDeviceDropdown.png" alt={189} align="center" src="https://files.readme.io/64715c6-rebootDeviceDropdown.png">
  Most Devices are able to be rebooted directly from Rev in the Actions dropdown
</Image>
