...
<Image alt="Use the Set Top Box Management module to accept Pending STBs found by Rev and configure Current STB channels" align="center" src="https://files.readme.io/5dbabc4-settopBoxes.png">
...
<Image title="pendingStbs.png" alt={1202} align="center" src="https://files.readme.io/8523969-pendingStbs.png">
  A Connector DME "listens" for Set Top Boxes and any it "finds" are placed under the Pending STBs tab
</Image>
...
<Image title="pendingStbAccepted.png" alt={505} align="center" src="https://files.readme.io/e8ec6ac-pendingStbAccepted.png">
  The STB(s) are accepted if they are not offline
</Image>

### Add Rev Channels Streams

The **Channel Settings** button is used to add channel streams for Current STBs. You *must* have previously added an IPTV stream in Rev using the [Add URLs](doc:link-to-video-urls) tab.
...
<Image title="channelSettings.png" alt={505} align="center" src="https://files.readme.io/1dd333a-channelSettings.png">
  Channels here are previously added through the Add Video > Add URLs function first
</Image>
...
<Image title="addNewChannel.png" alt={505} align="center" src="https://files.readme.io/348a32e-addNewChannel.png">
  To prepare a new Channel for use with an STB, you must add it in Channel Settings
</Image>
...
<Image title="setChannelStream.png" alt={505} align="center" src="https://files.readme.io/1577343-setChannelStream.png">
  Choose the channel to stream in the Set Channel dropdown.  It streams on the channels you selected.
</Image>
...
> ❗️ Warning!
>
> If you create a custom password for the STB in Rev and its **control IP** or **Port** is modified in the DME, the STB custom password *will* have to be re-entered again in REV. 
>
...
<Image title="deleteStb.png" alt={351} align="center" src="https://files.readme.io/740861f-deleteStb.png">
  Current STBs that are deleted are moved to the Pending STBs tab
</Image>
...
<Image title="setStatusStb.png" alt={335} align="center" src="https://files.readme.io/d865bd1-setStatusStb.png">
  Use the Bulk Action dropdown to modify the status of the STB as needed
</Image>
