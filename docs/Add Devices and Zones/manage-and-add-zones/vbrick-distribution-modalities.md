...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e131c55-distributionModalities.png",
        "",
        ""
      ],
      "align": "center"
...
> 4. Source Unicast
> 
> If a modality is not configured for a zone, it is ignored and **Playback URLs** are _not_ provisioned. At least one modality _must_ be selected for the zone.
