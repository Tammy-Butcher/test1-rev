...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/aae1b1c-vbrickECDNDevices.png",
        null,
      ...
      "align": "center",
      "caption": "Select a Device in the dropdown and then choose Available Streams to add to the Selected Streams column for Users to access in the Zone"
    }
  ]
}
[/block]
