...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/841a078-enableVbrickMulticast.png",
        "",
        ""
      ],
      "align": "center"
...
- The zone _must_ have at least one DME that is configured for multicast.  This includes:
...
> 📘 Note
> 
> Expiration dates for SSL certificates are listed in VBM Release notes. Refer to the [Device Compatibility Matrix](doc:compatibility-matrix)for the VBM version that is currently supported.