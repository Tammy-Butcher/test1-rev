...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5fdd6ca-cloudFetch1.png",
        "cloudFetch1.png",
        1086
      ],
      "align": "center",
      "sizing": "smart",
      "caption": "If the atta LocalNet stream is unavailable or has difficulties, Cloud Fetching is the fallback"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a724166-cloudFetch2.png",
        "cloudFetch2.png",
        1095
      ],
      "align": "center",
      "sizing": "smart",
      "caption": "DMEs that do not have v3.27+ cannot be configured for Primary and Secondary Fetching.  Secondary appears as 'Not Defined', seen here.  This is the default configuration."
    }
  ]
}
[/block]