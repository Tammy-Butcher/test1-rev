...
<Image title="updateDmeSoftware.png" alt={1202} src="https://files.readme.io/6bc6cc9-updateDmeSoftware.png">
  Use Bulk Actions > Update to update the software version of one or more DMEs
</Image>
...
> ❗️ Warning!
>
> You may *not* use the DME as a recording device during an update.
>
