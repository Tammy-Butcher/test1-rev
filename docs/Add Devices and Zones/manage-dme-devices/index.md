...
<Image align="center" alt={1202} border={false} caption="Account Admins use the DME Management module to obtain information and perform configuration options on their DME devices" title="dmeManagement.png" src="https://files.readme.io/71c4e72-dmeManagement.png" />
