...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e5aca6c-scheduleSync.png",
        "scheduleSync.png",
        1154
      ],
      "align": "center",
      "caption": "The Sync Now button performs an immediate content sync on demand"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3d25d8f-dmeScheduledDownload.png",
        "dmeScheduledDownload.png",
        202
      ],
      "align": "center",
      "caption": "Use the Bulk Action dropdown to create a common maintenance schedule for all of your DMEs"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/76ac729-bulkScheduleDmeDownload.png",
        "bulkScheduleDmeDownload.png",
        1202
      ],
      "align": "center",
      "caption": "Easily create a maintenance sync for your DMEs with the Scheduled Download option under Bulk Actions"
    }
  ]
}
[/block]
