...
If content subscriptions are enabled for your portal, the **Subscribe** button is visible on each individual channel page that you belong to when you access the [Channel Landing Page](doc:manage-channel-content#the-channel-landing-page).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e4976c6510da5b0ee8144fab3a12d3133c8908050cafc65efbff71f7d069d238-subscribeChannel.png",
