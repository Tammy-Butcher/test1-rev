...
The tables below indicate if a feature is available in the Vbrick Distribution product versus the full Vbrick Rev product offering. The tables are divided mainly by technology and/or Rev component where applicable.
...
| Admin Console                               | x                   | x          |
| Rev Portal                                  |                     | x          |
| Video Content Management                    |                     | x          |
| Events Calendar                             | x                   | x          |
| Webcast Creation and Execution Capabilities | x                   | x          |
...
| :----------------------------------------------- | :------------------ | :--------- |
| Public CDN                                       | x                   | x          |
| Edge Caching (via DME)                           | x                   | x          |
| Agentless Peer-to-Peer (via Vbrick Peer-to-Peer) | x                   | x          |
| Multicast with Agent                             | x                   | x          |
...
| Feature                                         | Vbrick Distribution | Vbrick Rev |
| :---------------------------------------------- | :------------------ | :--------- |
| Video Conference Integrations                   | x                   | x          |
| Video Conference Systems                        | x                   | x          |
| Zoom                                            | x                   | x          |
| Microsoft Teams                                 | x                   | x          |
| Webex Meetings                                  | x                   | x          |
| Webex Webinars (via Webex Webinars Integration) | x                   | x          |
| Encoders and RTMP Sources                       | x                   | x          |
| Self Produced Events (Webcam and Screenshare)   |                     | x          |
| Existing Video Source (VOD Asset)               |                     | x          |

### Webcasting Features

Vbrick Distribution includes a basic set of Webcast features, but to receive full access to all of our Webcasting capabilities you will need the full Vbrick Rev product.

| Feature                                | Vbrick Distribution | Vbrick Rev |
| :------------------------------------- | :------------------ | :--------- |
| Event Recording                        |                     | x          |
| Public Event Registration              | x                   | x          |
| All Users and Private event types      | x                   | x          |
| Attendee Engagement (Q&A, Chat, Polls) |                     | x          |
| Presentation Slides                    |                     | x          |
| Event-level Branding                   | x                   | x          |
...
| Playlists                     |                     | x          |
| Ratings                       |                     | x          |
| Supplemental File Attachments |                     | x          |
| Pulse Tab Flyout              |                     | x          |
...
| Feature                  | Vbrick Distribution | Vbrick Rev |
| :----------------------- | :------------------ | :--------- |
| Tagging Users in a Video |                     | x          |
| Video Transcription      |                     | x          |
| Video Translation        |                     | x          |

### APIs and Embedding

All of the Vbrick Rev API and Embedding capabilities are available with the Vbrick Distribution offering.
...
Vbrick Rev's storage add-on requires the full Vbrick Rev product at this time.
