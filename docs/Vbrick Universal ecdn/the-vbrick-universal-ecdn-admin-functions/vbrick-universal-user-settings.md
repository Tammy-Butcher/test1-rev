---
title: Vbrick Universal eCDN Users, Groups, and Channels
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
The **Users** option under the Admin menu consists of menu options created to assist Account Admins in maintaining users, groups, and channels in the Vbrick Universal eCDN.  Most settings here directly mirror Rev settings unless otherwise noted.

## Create a Vbrick Universal User Account

To create a new Vbrick Univeral eCDN User:

1. Navigate to **Admin** > **Users** and click the **Users** dropdown.
...
1. Navigate to **Admin** > **Users** and click the **Channels** dropdown.
