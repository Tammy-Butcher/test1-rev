---
title: The Vbrick Universal eCDN Home Page
excerpt: ''
deprecated: false
hidden: false
metadata:
...
## Viewing Universal eCDN System Analytics

In addition to event analytics, the Vbrick Universal eCDN also provides you with three system analytic dashboards. These are accessed under the **Reports** tab in the Admin menu options. Account wide system analytics are related to webcast events, user accounts, and general eCDN usage metrics.
