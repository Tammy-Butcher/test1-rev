...
[block:parameters]
{
  "data": {
    ...
    "0-0": "![](https://files.readme.io/5ecab1dbebaace1357e02e2b8e41810bf709ad9ba1ff3c5ea2777bf35fd78c5e-videoInformationIcon.png)",
    ...
    "1-0": "![](https://files.readme.io/b380628112f2a7dbfe1c11d1fb7d8591ee3916e67fb17aa055066ace62f13c38-videoCommentsIcon.png)",
    ...
    "2-0": "![](https://files.readme.io/5edc8e3bfc6466651aa7b57fe408e663180f0e0f00914127b96b8719e4c86431-videoSharingIcon.png)",
    "2-1": "[Sharing Panel](doc:rev-video-player-features#video-sharing)  \n  \nLink or embed the video you are viewing.",
    "3-0": "![](https://files.readme.io/3d8a7622223f1163ca45ad8ba1c4f86dd944e1b8f851ce7e50eab476a29c3d71-videoTranscriptIcon.png)",
    ...
    "4-0": "![](https://files.readme.io/d25f88171653c2434fe64d3cac31f9d1c1cc6f99631b5a24ea129dcf32495aa2-videoAssistantIcon.png)",
    ...
    "5-0": "![](https://files.readme.io/c8e9d2fabfb351a8929b3b291c199ffeb0bb228d8efee184583f0483f91e126a-videoPlaylistIcon.png)",
    ...
    "6-0": "![](https://files.readme.io/3596a8db586766256b81e58ff58deb74491db5d748e14ab7a214132957a8fc83-videoChaptersIcon.png)",
    ...
    "7-0": "![](https://files.readme.io/4732b03ed2877c620b47002a74eca09b125e13dfcd252a2b43724ede358cdf52-videoReportsIcon.png)",
...
[block:parameters]
{
  "data": {
    ...
    "1-0": "![](https://files.readme.io/96f859003a928ecc198b1724bfe115eb0c86d887f0575245a31c236e38751ffd-downloadVideo.png) ",
    ...
    "2-0": "![](https://files.readme.io/6e5af2f1bceb9a0ef001978679493de851aa964591449437e34386ff5b80a670-exportLMS.png)",
    "2-1": "[Export a Video for a Learning Management System (LMS)](doc:export-a-video-for-a-learning-management-system-lms) if you have the correct permissions.  Not visible if you do not have an Admin or LMS Exporter role.",
    "3-0": "Description",
    "3-1": "The [description](doc:update-basic-video-settings#title-and-description) that is entered in video settings. Includes a disclaimer if it was auto-generated by Rev's Generative AI features.",
    "4-0": "Total Views",
    "4-1": "Total number of views (including **Last Viewed** date and time based on user’s time zone)",
    "5-0": "Owner",
    "5-1": "The [video owner](doc:video-owner) is the uploader by default but a video owner can also be assigned that is not the original uploader.",
    "6-0": "Upload Date",
    "6-1": "The date and time that the video was [uploaded](doc:upload-video).",
    "7-0": "In This Video",
    "7-1": "Users that are [tagged](doc:update-basic-video-settings#tag-users-in-a-video) in a video.  \n  \nTimeline tagging that highlights on the timeline where in the video speakers are present is available _only_ if [Facial Recognition](doc:facial-recognition) is enabled (disabled by default).  \n  \n- Profile pictures that have tagging enabled are indicated by an arrow > next to their image. If enabled, click the profile picture to highlight the range the speaker appears on the timeline.\n\n- Users may opt-out of [tagging](doc:update-basic-video-settings#tag-users-in-a-video) any time by updating their [Profile Settings](doc:your-rev-profile#update-your-profile-image).",
    "8-0": "Categories",
    "8-1": "[Categories](doc:update-basic-video-settings#categories-and-tags) the video belongs to; clicking a category will take you to the Category archive page and display all videos that belong to that specific category.",
    "9-0": "Tags",
    "9-1": "[Tags](doc:update-basic-video-settings#categories-and-tags) the video has been assigned; clicking a tag will take you to a search results page and display all videos that have been tagged with that specific tag.",
    "10-0": "Custom Fields",
    "10-1": "[Custom fields](doc:update-basic-video-settings#use-a-custom-field), if defined, appear beneath the Tags field.",
    "11-0": "Rating",
    "11-1": "[Rate](doc:update-basic-video-settings#enable-comments-ratings-and-downloading) the video from 1 to 5 stars and view ratings that have already been applied.  \n  \nThe **Rating **indicates the \"average rating received\" while the the **Total Ratings** is the \"total number of ratings\" received on the video to date.",
    "12-0": "Supplemental Files",
    "12-1": "If [supplemental files](doc:update-advanced-video-settings#attach-a-supplemental-file) are attached to the video they are downloaded from this panel.",
    "13-0": "Inappropriate Content",
    "13-1": "Flag or report video for inappropriate content.  \n  \nClick the **Report **icon to flag the video for inappropriate content.  Account and Media Admins will receive a notification in Rev and an email so that the video may be reviewed.",
    "14-0": "Password Protected Notification",
    "14-1": "If the video is a [Public](doc:create-event#schedule-a-public-event) video and **Password **protected, it is noted on this panel.",
    "15-0": "Approval Process Stage",
    "15-1": "Present if the video is part of an [Approval Process](doc:define-an-approval-process)",
    "16-0": "Uploader",
    "16-1": "The [video owner](doc:video-owner) is the person who uploads the video but this can be reassigned."
  },
  "cols": 2,
  "rows": 17,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6fd62c3102fc2ff81d4e07f2c5fe2505b55409e7e041677cdcd87ec8bc6e7049-videoAssistantFlyoutRevPlayer.png",
        "",
