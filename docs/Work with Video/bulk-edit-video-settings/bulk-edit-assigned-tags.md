...
next:
  description: ''
---
Use the [Tags](doc:video-categories-and-tags) control in the [Bulk Edit](doc:bulk-edit-video-settings) interface to add, remove, or replace one or more tags to several videos at once. 
