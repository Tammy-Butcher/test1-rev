...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cfd2260-enableVideoFeatures.png",
        "enableVidFeatures.png",
        "Individual video features must be enabled to use them"
      ],
      "align": "center",
      "caption": "Individual video features must be enabled to use them"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f98595b-enableViewerIDWatermarking.png",
        null,
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fb29a18-videoWatermarked.png",
        null,
        "Floating viewer information displays during playback if Viewer ID is enabled to discourage recording and sharing with outside sources"
      ],
      "align": "center",
      "caption": "Floating viewer information displays during playback if Viewer ID Watermark is enabled to discourage recording and sharing with outside sources"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4f7046c-showChapterImagesEnabled.png",
        "",
        "Toggle the Show Chapter Images By Default switch if you want chapter images to display every time a video is accessed"
      ],
      "align": "center",
      "caption": "Toggle the Show Chapter Images By Default switch if you want chapter images to display every time a video is accessed"
    }
  ]
}
[/block]
...
This switch is _only_ visible if [chapters are added to the video](doc:add-chapters-to-a-video) and at least one chapter contains an image. The toggle switch will _not_ be visible if there are no chapters or no images for the video.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8123be7-hideChapterImages.png",
        "",
        ""
      ],
      "align": "center"
