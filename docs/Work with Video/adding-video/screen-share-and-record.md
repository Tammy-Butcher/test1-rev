...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/999d6820ddb66290250b8673317c1845768d9928b02c88ee5d854d8d9e879b62-screenRecorder.png",
        "",
        ""
      ],
      "align": "center"
...
- To use the Screen Recorder, you _must_ make sure you add the <https://*.vci.vbrickrev.com> URL to your [Required URLs and Allowed Lists](doc:rev-required-urls-and-allowed-lists).
...
- You _must_ enable either a screen or a camera (or both).  You cannot have both disabled and record audio only.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1eb77c7be167343902515331b027f9658db1ffe159578dc8a1c483b08b2235a9-enableScreenCamera.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4cc8afb171d720a30c9b880410fc5ca082aa3d6bcae679eec2a088dc2166c334-initialLaunch.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c4683f364581404445f1ef85cee25573dd2ce5b010249fa2bc078aad1b867a6d-contentShareOptions.png",
        "",
        "Toggle Screen options to view browser tab and window options you have open or to share your entire screen"
      ],
      "align": "center",
      "caption": "Toggle Screen options to view browser tab and window options you have open or to share your entire screen"
    }
  ]
}
[/block]
...
> 
> This is _not to be confused_ with your microphone audio which is selected and recorded differently. This audio is your browser's audio if any exists and may conflict with microphone audio if you plan to use it.  Be aware of this and set the toggle accordingly.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7359eac70dc76933b389d462012375eb074144ed7b46cc3915508b292bd0a0a4-previewCamera.png",
        "",
        "Your default camera is pre-selected for you and you are also able to choose permissions for it"
      ],
      "align": "center",
      "caption": "Your default camera is pre-selected for you and you are also able to choose permissions for it"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cde42e2c990a5769bd656bd7c236f0b1ed6b2616bc1beebe5019a88e53cc6763-previewAudio.png",
        "",
        "Your default microphone is also pre-selected for you and recording levels can be seen in the toggle box"
      ],
      "align": "center",
      "caption": "Your default microphone is also pre-selected for you and recording levels can be seen in the toggle box"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/164f075dbc9cd04563ddeba67296efcbdcd7564c4128300c34d97facf71d4a58-resetPermissions.png",
        "cameraMicrophoneAccess.png",
        412
      ],
      "align": "center",
      "caption": "You must make sure that you allow Rev access to camera and microphone to use this function.  If you accidentally block Rev, click the site info icon in your browser's URL."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e3e8b10923201cc206f00041b51ed887c41f925702cd9b45419eca5263576b68-recordCountdown.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e8d3e395a3f9b975d7ffca3c82297d3a94adfcafb1d2f3b089caec28ee14385d-endRecording.png",
        "",
        ""
      ],
      "align": "center"
