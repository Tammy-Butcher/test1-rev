...
> 👍 Tip
>
> This feature is only available in Rev Cloud for those Rev users that have media creation/upload rights.  To use this feature, you need to add the [https://\*.vci.vbrickrev.com](https://*.vci.vbrickrev.com) URL to your [Allowed Lists](doc:rev-required-urls-and-allowed-lists).
...
1. Click the [Upload](doc:adding-video) icon > **Live Recording** tab and then make sure **Screen Recording** is selected.

2. Click the **Start** button to open a **Capture** window.

<Image alt="The Screen Recording tab allows screen sharing and recording directly from Rev" align="center" src="https://files.readme.io/09956ff8cd2c952126b5d047039877d4f9a54c6aa115d83a49e08bcd200cb670-screenRecording.png">
...
<Image alt="You can enable screen sharing or your webcam or both when you enable Screen Recording" align="center" src="https://files.readme.io/f7758a1a3e9d212bdb838cf2f6418e081f03930509fc63679418cd796ecdefdf-blankScreenShare.png">
...
Note that in this case, you are able to switch between the Chrome tab(s), the browser window, and your entire screen.
...
<Image title="screenShareSelect.png" alt="Toggle the Screen option to On to view your screen sharing options" align="center" src="https://files.readme.io/668408ff50d233bf8898b76f336afc7ae63544894a026c0b55d62e7c2325989b-chooseWhat2Share.png">
  Toggle the Screen option to On to view your screen sharing options
</Image>
...
<Image title="chooseWebCamOptions.png" alt="Choose your Webcam options to record a speaker along with your selected screen share" align="center" src="https://files.readme.io/ae707286502ba63f13c42ecdeb70e78cb0a2c2e87f127a350bffe61c274cb08f-toggleCameraOn.png">
  Choose your Webcam options to record a speaker along with your selected screen share
</Image>
...
<Image title="recordContent.png" alt="Recording controls are displayed beneath the recording windows. The Finish button saves your video recording and uploads it to Rev where you can edit it." align="center" src="https://files.readme.io/bb0a85358f2986b14fd8b2b87763b49c3017f03c090287953bbddf373e117fde-recordingButtons.png">
  Recording controls are displayed beneath the recording windows. The Finish button saves your video recording and uploads it to Rev where you can edit it.
</Image>
...
<Image title="cameraMicrophoneAccess.png" alt={412} align="center" src="https://files.readme.io/4aabd9b-cameraMicrophoneAccess.png">
  You must make sure that you allow Rev access to camera and microphone to use this function.  If you accidentally block Rev, click the microphone in the upper right corner of the Rev Share window.
</Image>
