...
<Image alt="Click the Upload Files tab and then Add Files" align="center" src="https://files.readme.io/2d4a9f6-uploadVideoFromHarddrive.png">
...
5. If you do not want *all* of the metadata generated, use the carrot dropdown to choose which specific fields to auto-generate for you.
...
<Image alt="Use the dropdown to choose which metadata to generate if desired" align="center" src="https://files.readme.io/3824e0f-uploadVideoAIGenerate.png">
  Use the dropdown to choose which metadata to generate if desired instead of all at once
</Image>
