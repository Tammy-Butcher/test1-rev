...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8a1fc52-replaceVideo.png",
        null,
        "The Replace Video option is available if you have the correct permissions or role assigned to your account"
      ],
      "align": "center",
      "caption": "The Replace Video option is available if you have the correct permissions or role assigned to your account"
    }
  ]
}
[/block]
