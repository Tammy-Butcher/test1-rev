...
[Unlisting](doc:unlist-a-video) a video is similar to deactivating it except it prevents it from being displayed to _all_ viewers who do not have edit rights within the Rev UI including those with Approver role access.
...
<Image align="center" alt="The Replace Video option is available if you have the correct permissions or role assigned to your account" border={false} caption="The Replace Video option is available if you have the correct permissions or role assigned to your account" src="https://files.readme.io/8a1fc52-replaceVideo.png" />
...
You may cancel and restore the original video until it has finished uploading by clicking the **Restore original video** button on the upload dialogue box. Once it has finished uploading, you may _not_ use the restore function.
...
* A new thumbnail is generated from the _new_ video file.
...
> 📘 Note
>
> Video analytics associated with the video are _not_ removed. They are preserved for historical reporting purposes.
