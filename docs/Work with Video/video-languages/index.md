...
<Image title="revIQTranscription.png" alt="The Languages tab displays default transcription and translation languages that are set for video uploads" align="center" src="https://files.readme.io/78406b409153e5efd8ad01b2edba071b5c64499f62a695e75ffb47e077d9efe4-languagesTab.png">
  The Languages tab displays default transcription and translation languages that are set for video uploads
</Image>

In the image above, when the video is uploaded, the **Automatic Transcription Language** and voice **Audio Track** (English) are displayed on the top row and become the default. The Account Admin also configured automatic translation to occur in French and Spanish and, as a result, the **Automatic Translation Languages** rows are listed in alphabetical order *under*  the English file default row.  You can specify that a [voice Audio Track be generated](doc:adding-alternative-audio-tracks-to-a-video) for those rows as well.
