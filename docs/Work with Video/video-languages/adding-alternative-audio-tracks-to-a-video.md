---
title: Add Alternative Audio Tracks to a Video
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
You have the option to generate up to ten alternative voice **Audio Tracks** for a video file. This means that you can upload a video with an English speaker and then add audio tracks for French, Spanish, and German speakers for example.

Note that before you are able to do this you must first have a **Subtitle** file in place for the language along with [Rev IQ](doc:rev-iq-transcription-and-translation) enabled with [Rev IQ credits](doc:rev-license-types-and-add-ons#rev-iq-credits).  Further, only [supported audio/voice languages](doc:supported-languages#vod-audio-and-voice-language-support-for-rev-iq) can be generated.

To generate an additional voice **Audio Track** for a video:
