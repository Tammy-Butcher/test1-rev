...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7a2b110-accessBulkEdit.png",
        "bulkEditUI.png",
...
Click the **Edit Videos** gear icon to the right of the selected videos to access the bulk editing features that you may apply to them.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2e244c0-bulkEditIcons.png",
        "bulkEditIconGear.png",
        "The Edit Videos gear provides access to most bulk editing functions"
      ],
      "align": "center",
      "caption": "The Edit Videos gear provides access to most bulk editing functions"
    }
  ]
}
[/block]
