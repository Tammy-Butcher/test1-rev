...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Returns (here) to the Rev Home page
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        * My Subscriptions
        * Expirations
        * My Channels. Note that content under this menu option is permission specific based upon the roles you have been assigned.
      </td>
    </tr>
    ...
    <tr>
      <td>
        [The Rev Screen Recorder](doc:screen-share-and-record)
      </td>

      <td>
        Record and then share a video directly from your desktop.  Must be enabled first by an Admin before this icon is visible.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Quickly create a Live event (defaults to Webcam and Screenshare event) in Rev.
      </td>
    </tr>
