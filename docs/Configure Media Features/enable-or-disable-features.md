---
title: Allow Video Setting Features
excerpt: >-
  A complete description of how to enable or disable global features and
  settings in the Rev portal
deprecated: false
hidden: false
metadata:
  title: ''
...
next:
  description: ''
---
Account Admin accounts can use the **Media Settings > Features** menu to globally allow specific settings to appear throughout the Rev portal so that other account types can then enable or disable them as needed. 
