...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4791888-enableContentAnalysis.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c2eceee-keywordSearch.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f67a972-bypassApproverOff.png",
        "",
        "In this approval step, final approval is always left to the users and groups"
      ],
      "align": "center",
      "caption": "In this approval step, final approval is always left to the users and groups"
    }
  ]
}
[/block]
...
In this case, **Users** and **Groups** in the **Approvers** box are _always_ required to approve (or reject) the content in this step no matter the outcome of the AI-Content analysis that is performed.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cbb7dd4-bypassApproverOn.png",
        "",
      ...
      "align": "center",
      "caption": "In this approval step, final approval is only passed to the users and groups if an issue is detected by Rev's Generative AI"
    }
  ]
}
[/block]