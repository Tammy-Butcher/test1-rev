...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/95e85df-recordingDME.png",
        "recordingDME.png",
        760
      ],
      "align": "center",
      "caption": "Navigate to Media Settings > Recording to set your Primary and Secondary recording options.  You must set up your DME devices first."
    }
  ]
}
[/block]
