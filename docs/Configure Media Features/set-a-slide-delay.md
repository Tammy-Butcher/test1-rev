...
* Enter the **Delay in Seconds**. The **default** is 24 seconds. This is the number of seconds that will occur between *each* slide transition.

<Image title="slideDelay.png" alt="Enter the delay you want to occur between each slide transition. The default is 24 seconds." align="center" src="https://files.readme.io/672441e-slideDelay.png">
  Enter the delay you want to occur between each slide transition. The default is 24 seconds.
</Image>
