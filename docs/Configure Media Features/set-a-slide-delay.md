...
* Enter the **Delay in Seconds**. The **default** is 24 seconds. This is the number of seconds that will occur between \_each \_slide transition.

<Image title="slideDelay.png" alt={705} align="center" src="https://files.readme.io/672441e-slideDelay.png">
