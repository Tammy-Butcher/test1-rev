...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ccc7c90-categories.png",
        "categories.png",
        902
      ],
      "align": "center",
      "caption": "Use the Categories form to create both new categories and subcategories"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/53f0a4c-addThumbnailtoCategory.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8d734cb-categoriesGridView.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d61bd2bb6e6a0dd52fbaf582876bbffed8ae635d241be149b211b89135f6af60-categoryGear.png",
        "",
        ""
      ],
      "align": "center",
      "caption": "Edit category features by clicking the Gear icon on the Browse Categories page"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b3e77d6-addSecureCategory.jpg",
        "addSecureCategory.jpg",
        902
      ],
      "align": "center",
      "caption": "Enable the Restricted checkbox to create a Secure Category and add users and groups. Then assign the permissions to them to manage it."
    }
  ]
}
[/block]
...
3. Assign either a **Category Manager** or **Category Contributor** permission.
   - **Category Managers** can edit the **Category Name** and add subcategories; **Category Contributors** can only add content. You should designate at least _one_ Category Manager for every Secure Category you create.
...
4. Videos associated with deleted categories and subcategories are disassociated but _not_ deleted.