...
4. Thumbnails display in both grid and list view.  If a thumbnail has not been applied, a placeholder default image is used instead. Note: The default image is always applied to uncategorized.
