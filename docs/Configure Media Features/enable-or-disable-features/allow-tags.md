...
next:
  description: ''
---
[Tags](doc:video-title-description-and-tags) provide a means for your users to provide their own classification system. This feature is enabled by default. 

To globally enable tags, select the **Allow tags on all media** checkbox under **Media Settings** > **Features** > **Video Settings**.
