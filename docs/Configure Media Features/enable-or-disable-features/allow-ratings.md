...
next:
  description: ''
---
[Ratings](doc:video-features) are a means to provide additional feedback on content by using a star-based ranking system. Users can use this feedback if they do not want to leave a comment (or in addition to comments). 

This feature is enabled by default. To globally enable ratings, select the **Allow ratings on all media** checkbox under **Media Settings** > **Features** > **Video Settings**.
