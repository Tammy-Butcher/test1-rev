...
next:
  description: ''
---
Embedding must be enabled if you want to provide access to media embed code that can be placed on a 3rd-party Website or portal. This means that viewers are not required to use the Rev portal to view videos and/or webcasts. This feature is enabled by default.

1. Select **Allow access to embed code on all media** checkbox under **Media Settings** > **Features** > **Video Settings**. 
...
<Image title="allowEmbeds.png" alt={842} align="center" src="https://files.readme.io/96f7a11-allowEmbeds.png">
