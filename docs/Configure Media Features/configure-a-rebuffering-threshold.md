...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3f345bf-experiencedRebuffering.png",
        "experiencedRebuffering.png",
        694
      ],
      "align": "center",
      "caption": "This setting configures rebuffering thresholds for Webcast events and should not be reset without first consulting Vbrick first"
    }
  ]
}
[/block]
