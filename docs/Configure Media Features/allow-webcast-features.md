...
To enable, select the **Allow Chat on Webcasts** checkbox in the **Webcast User Engagement** section.
...
To enable this feature, make sure you have the **Send a Message/Link (Banner) to all Attendees** option checked.

## Allow Moderators to Remove Attendees

If you have the **Allow moderators to expel users from a webcast** option checked, moderators are able to [remove and restore webcast attendees](doc:host-a-production-webcast#viewing-and-removing-attendees) just as Event Admins and Event Hosts can.
