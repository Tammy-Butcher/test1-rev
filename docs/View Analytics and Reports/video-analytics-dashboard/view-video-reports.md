...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e5198cd-downloadVideoViewsReport.png",
        "downloadVideoViewsReport.png",
        905
      ],
      "align": "center",
      "caption": "The CSV tab next to the Date Control downloads the Video Views report from the Video Analytics Dashboard"
    }
  ]
}
[/block]

A \<video_name>.csv file is downloaded to your **Downloads **folder with the following viewing data statistics about the video:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/21ff674-downloadVideoInventoryReport.png",
        "downloadVideoInventoryReport.png",
        352
      ],
      "align": "center",
      "caption": "If you click the CSV icon without filtering it, the report downloads all the videos, all the uploads, all of the category, and so forth"
    }
  ]
}
[/block]
