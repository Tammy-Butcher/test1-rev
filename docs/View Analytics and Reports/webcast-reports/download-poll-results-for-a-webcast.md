---
title: Download Poll Results for a Webcast
excerpt: ''
deprecated: false
hidden: false
metadata:
...
2. Click the **Polls CSV** option.
3. The log is placed in your Downloads folder as **Polls.csv** (including the event name).