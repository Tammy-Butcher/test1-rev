...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/99b2318715cfb7383b57969874fabfdd88c04bd545c02a3161457f4b98a4e0ce-downloadButton.png",
        "downloadsMenu.png",
        356
      ],
      "align": "center",
      "caption": "The Download button provides access to all reports generated from the webcast.  If a feature is not enabled, a report is not generated."
    }
  ]
}
[/block]
...
Each type of webcast report available is described in more detail in the topics in this section.