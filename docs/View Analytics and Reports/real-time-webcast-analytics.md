...
next:
  description: ''
---
Rev provides access to a **Real-Time Dashboard** during your Live webcasts. This allows you to gain insights on streaming <Glossary>bit rate</Glossary> and user <Glossary>bandwidth</Glossary> to understand network performance and optimize video for any location and device.

> 📘 Note
>
> The Real-Time Dashboard is a Rev Cloud only feature.

<Image align="center" src="https://files.readme.io/7549cf8-realTimeDashIcon.png" />
...
<Image title="dashboardKPI.png" alt="1795" align="center" src="https://files.readme.io/c6b2219-dashboardKPI.png">
  Live Webcast Key Performance Indicators (KPIs) are displayed first
</Image>
