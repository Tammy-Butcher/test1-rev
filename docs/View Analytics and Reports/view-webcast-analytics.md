...
next:
  description: ''
---
Webcast Analytics provide insight to the types of attendees that viewed the event, their quality of experience, and their viewing tendencies and trends while the webcast was ongoing. They are accessed by clicking the **Reports** button on the event once it has concluded.

<Image alt="The Reports button displays Main Event and Pre-Production (&#x22;Dry Run&#x22;) Event Analytics and Reports" align="center" src="https://files.readme.io/92ad45fc9b799b8324550fbe691cc1200889c4980d9715a3e98f5f2de2856b51-reportsButton.png">
  The Reports button displays Main Event and Pre-Production ("Dry Run") Event Analytics and Reports
</Image>

> 👍 Tip
>
> The **Reports** button contains both **Main Event** and **Pre-Production** report access if you set up a "dry run" event. If the Main Event has not yet started, then only Pre-Production events are available. If no Pre-Production dry runs are conducted, only the Main Event report is displayed as seen above.
>
...
<Image title="engagementAnalytics.png" alt={1202} align="center" src="https://files.readme.io/069bb94-engagementAnalytics.png">
  The top KPIs under the Engagement Analytics tab displays Attendee viewing trends
</Image>
...
<Image title="qualityOfExperience.png" alt={1800} align="center" src="https://files.readme.io/c57fbcd-qualityOfExperience.png">
  The top KPIs under the Quality of Experience tab display details related to the viewing experience
</Image>
...
<Image title="users.png" alt={1202} align="center" src="https://files.readme.io/6b42a46-users.png">
  Filter and view user data by using the Columns control
</Image>
