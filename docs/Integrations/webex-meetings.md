...
> 🚧 Important!
> 
> As of Rev v7.52 you must make sure you have updated your Webex Meeting App to make sure it is compatible with new APIs and contains the new [scopes](doc:webex-meetings#webex-meeting-app-setup) detailed below or it will _not_ function correctly!
