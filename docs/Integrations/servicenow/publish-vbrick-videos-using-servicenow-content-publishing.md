...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8ebc71e-addVbrickVideo.png",
        null,
        "Add the videos you want to use by searching on them first through Add a Vbrick Video"
      ],
      "align": "center",
      "caption": "Add the videos you want to use by searching on them first through Add a Vbrick Video"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5e198a2-videoDetails.png",
        null,
        "The Video ID seen here can also be used in the Vbrick Video By ID widget"
      ],
      "align": "center",
      "caption": "The Video ID seen here can also be used in the Vbrick Video custom widget"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/59019d7-contentLinks.png",
        null,
        ""
      ],
      "align": "center"
