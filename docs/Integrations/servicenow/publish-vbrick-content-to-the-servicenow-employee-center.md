...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c9193cf-employeeCenterContentPublish.PNG",
        "",
        ""
      ],
      "align": "center"
...
> 🚧 Important!
> 
> The **Employee Center** integration _requires_ **Content Publishing v31.0.3** or greater. View the installation documentation packaged with your zip file for prerequisite and configuration details.
...
Before you are able to proceed, make sure your Account Admin has properly [installed and configured the Vbrick Video app](doc:servicenow#installation) for ServiceNow in addition to the **Vbrick Video Employee Center Pro** integration from the ServiceNow Store.  This step _must_ be completed before you are able to publish Vbrick content to Employee Center.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ae6ad85-openVideoLibrary.png",
        "",
        "The Rich Content Editor configured for Vbrick Videos"
      ],
      "align": "center",
      "caption": "The Rich Content Editor configured for Vbrick Videos"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/653ba77-employeeCenterPublishPlan.PNG",
        "",
        "The videos displayed are based on the current user (access) and the (configured) Vbrick Portal"
      ],
      "align": "center",
      "caption": "Specify Publish attributes for the video such as location, page, and widget"
    }
  ]
}
[/block]
