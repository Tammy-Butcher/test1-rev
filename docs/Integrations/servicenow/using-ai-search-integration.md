...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/97c8eda7ae631c9e9a49501ff1671db1cf4bcaec14563e8098ffc53e54094162-AISearchConnectorOptions.png",
        "",
        "Two new options are available once the Vbrick Video AI Search Connector is installed"
      ],
      "align": "center",
      "caption": "Two new options are available once the Vbrick Video AI Search Connector is installed"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/31a1acc3782329a6ad4aa2be3fad372c2f1586e81d4a4a38328236bd57391188-now_assist_navigation.png",
        "",
        "Select Now Assist Multi-Content Response to enable Vbrick External Content responses in Now Assist for each portal"
      ],
      "align": "center"
    }
  ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e02f0dc393202977fbfff71c2d6025c3aa8089e844731b5c8cd87660ad2e20af-Set_up_Now_Assist_in_AI_Search.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/05975793abcaef32f3f1611efe0fbb5fa710d837b9d8cba5096763395514d158-searchSettingsPage.png",
        "",
        ""
      ],
      "align": "center"
...
- All videos from Vbrick Rev that are **Public** or **All Users** are indexed into the AI search automatically, every hour. **Private** videos are restricted and _not_ synced.
...
- All videos from Vbrick Rev that are **Public** or **All Users** are indexed into the AI search just as if the Sync Videos toggle is performing an automatic sync. **Private** videos are still restricted and _not_ synced.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/35b0901e4e722769af99311f514b9d59ed7aa2d1bbc0b2a01a78007c2175e3ba-searchResults.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6681ad06b351c80b30743fed3b84fca46af49a595207b5fb6ca03e50abce7643-searchLogs.png",
        "",
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8f269a2e0c7a514aba94a9a91eb87c23610f8ed799f5d6caf92e8b21e14a9b3c-stopSync.png",
        "",
        "A delete sync type occurs when you toggle sync off. The videos are removed from AI Search."
      ],
      "align": "center",
      "caption": "A delete sync type occurs when you toggle sync off. The videos are removed from AI Search."
    }
  ]
}
[/block]
