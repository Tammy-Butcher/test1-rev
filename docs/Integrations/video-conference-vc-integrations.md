...
<Image align="center" alt={1141} border={false} caption="You must enable the Video Address Conference Integration checkbox to use VC/SIP addresses as video sources" title="enableVcRecordingStreaming.png" src="https://files.readme.io/757b0e5-enableVcRecordingStreaming.png" />
...
<Image align="center" alt="The Video Address option under the Recording tab displays all of Rev's native and integrated recording options available" border={false} caption="The Video Address option under the Recording tab displays all of Rev's native and integrated recording options available" src="https://files.readme.io/757159c-recordVidConference.png" />
...
<Image align="center" alt={1140} border={false} caption="The Video Address tab is not visible on a Webcast Event until you enable the Video Address Conference integration" title="vcStreamWebcastUsage.png" src="https://files.readme.io/7af3fe2-vcStreamWebcastUsage.png" />
