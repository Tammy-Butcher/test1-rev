...
First we will create the necessary JSON to populate into Microsoft Teams to use Vbrick Universal eCDN.  Below is the necessary JSON for Microsoft.  You will notice the section "rev" -- this needs to be replaced by the JSON provided by the Rev / Vbrick Universal eCDN interface.
...
You will notice the section "rev" -- this needs to be replaced by the JSON provided by the Rev / Vbrick Universal eCDN interface.  Below is an example of the JSON.

```Text JSON from Rev / Vbrick Universal eCDN
{
  "hostName": "ramprc.kevin.vbrick.com",
  "jwtKeyName": "RevConnectDefault",
  "apiKey": "gKPEYHHD",
