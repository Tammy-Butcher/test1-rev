...
<Image align="center" alt="View Rev content directly in your Teams environment" border={false} caption="View Rev content directly in your Teams environment" src="https://files.readme.io/4dcc65f-teamsChannelEmbed.png" />
...
<Image align="center" alt={802} border={false} caption="Select the Microsoft Teams Integration checkbox to enable Rev content on Teams Channel tabs" title="enableMsTeamsIntegration.png" src="https://files.readme.io/05c1dd0-msTeamsEnabled.png" />
...
<Image align="center" alt={722} border={false} caption="Rev appears in the Microsoft Teams tenant and can be added to Team Channels" title="revMsTeamsApp.png" src="https://files.readme.io/e9c63c7-revMsTeamsApp.png" />
...
<Image align="center" alt="Search for the Vbrick Rev app to install to your Channel tab from the Apps list in MS Teams" border={false} caption="Search for the Vbrick Rev app to install to your Channel tab from the Apps list in MS Teams" src="https://files.readme.io/a6d98ff-msTeamsListing.png" />
...
<Image align="center" alt="You will be prompted to add the Vbrick Rev app to an existing MS Team" border={false} caption="You will be prompted to add the Vbrick Rev app to an existing MS Team" src="https://files.readme.io/850b1f2-addRevtoMSTeam.png" />
...
<Image align="center" border={false} src="https://files.readme.io/f70948e-revAccountLogin.png" />

5. Once you select a Team, you are prompted to select a **Channel** to configure.

<Image align="center" alt="You will select an initial Channel and begin setting up individual tabs" border={false} caption="You will select an initial Channel and begin setting up individual tabs" src="https://files.readme.io/c02e0c5-addRevtoMSTeamsChannel.png" />
...
<Image align="center" alt="The Resource Type determines what Rev functionality appears on your new tab" border={false} caption="The Resource Type determines what Rev functionality appears on your new tab" src="https://files.readme.io/6c8260f-addChanneltoMSTeams.png" />
...
<Image align="center" alt="Rev content is embedded seamlessly into your MS Teams channel" border={false} caption="Rev content is embedded seamlessly into your MS Teams channel" src="https://files.readme.io/ad4c1a5-teamsChannelEmbed.png" />
...
<Image align="center" alt="The Vbrick Personal Tab displays the VOD page of the tenant you log in to" border={false} caption="The Vbrick Personal Tab displays the VOD page of the tenant you log in to" src="https://files.readme.io/6695731-addPersonalTab.png" />
...
<Image align="center" alt="Right+click on the app to pin it to your Personal Tab" border={false} caption="Right-click on the app to pin it to your Personal Tab" src="https://files.readme.io/d93c6d9-pinPersonalTab.png" />
