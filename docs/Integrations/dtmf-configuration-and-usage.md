...
<Image align="center" alt={1138} border={false} caption="Zoom's sample DTMF configuration" title="codeConfig.png" src="https://files.readme.io/740627a-codeConfig.png" />
...
<Image align="center" alt={1157} border={false} caption="An example of using DTMF codes with a Zoom event in Rev" title="dtmfEventSetup.png" src="https://files.readme.io/4f35d18-dtmfEventSetup.png" />
...
<Image alt="DTMF codes are injected once Rev connects to the VCI call" border={false} caption="DTMF codes are injected once Rev connects to the VCI call" src="https://files.readme.io/8656d0f-dtmfCodes.png" />
