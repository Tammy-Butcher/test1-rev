...
[block:parameters]
{
  "data": {
    ...
    "1-0": "Scopes",
    "1-1": "`spark:messages_write`  \n  \nPost and delete messages on your behalf  \n  \n`spark:rooms_read`  \n  \nList the titles of rooms that you are in",
    "1-2": "**Note**: If you also plan to enable the [Webex Meetings](doc:webex-meetings)  integration, you may use this same Teams App and select `spark:all` here instead."
  },
  "cols": 3,
  "rows": 2,
  "align": [
