...
<Image title="privateEventType.png" alt={700} src="https://files.readme.io/d21ddbf-privateEventType.png">
  A private event only allows those users and groups you specify in the Find Items control to attend
</Image>
