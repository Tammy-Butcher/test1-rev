...
<Image title="automaticRecording.png" alt={502} align="center" src="https://files.readme.io/bbb65d8-automaticRecording.png">
  Enable automatic recording to set the webcast to record automatically as soon as the Event Host broadcasts the event
</Image>
...
Linking and redirecting Webcast recordings offers attendees the ability to seamlessly transition from viewing a live webcast to its recording once it has completed. Event Hosts control *when* it is redirected so that it may be edited before it is viewed if desired.

<Image title="linkRedirect.png" alt={402} align="center" src="https://files.readme.io/964c401-linkRedirect.png">
...
* In the event that multiple recordings took place during the webcast, the *last* recording is associated upon event completion
...
<Image title="landingPageLinkRedirect.png" alt={722} align="center" src="https://files.readme.io/a1d54f2-landingPageLinkRedirect.png">
  You can disable redirecting from the Webcast Landing Page if needed to make necessary adjustments
</Image>

## Select the Uploader for the Recording

The creator of the event is specified as the **Uploader** by default but it may be changed to any system user during set up and is *not* limited to the Hosts or Moderators of the event.
