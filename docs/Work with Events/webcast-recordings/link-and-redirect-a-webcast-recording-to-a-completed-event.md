...
next:
  description: ''
---
Linking and redirecting webcast recordings offers attendees the ability to seamlessly transition from viewing a live webcast to its recording once the event is complete. Event Hosts also control *when* it is redirected so that it may be edited before it is viewed if desired.

<Image title="linkRedirect.png" alt="These two settings specify to link the webcast recording to the completed event and then to redirect attendees to the linked recording once you are done editing it" align="center" src="https://files.readme.io/b8433004ed7790d7ee6afc43be62d76ae837a7375d73e54a9670b8dbe8cd8e2f-enableWebcastLinkRedirects.png">
