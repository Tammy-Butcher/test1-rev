...
<Image align="center" alt={1147} border={false} caption="The Listing Type determines what settings are available.  All types can be unlisted and estimate number of attendees." title="attendeesSection.png" src="https://files.readme.io/1902e13-attendeesSection.png" />
...
<Image align="center" alt="If you enable Viewer ID Watermark for the event, the viewer's information is displayed during the playback of the recorded event" border={false} caption="If you enable Viewer ID Watermark for the event, the viewer's information is displayed during the playback of the recorded event" src="https://files.readme.io/8fb7d73-videoWatermarked.png" />
