...
<Image title="rebroadcastPreview.png" alt={1861} align="center" src="https://files.readme.io/6cc80b0-rebroadcastPreview.png">
  Event Hosts are able to preview the VOD source before the event begins
</Image>

When automated webcast is enabled, just above the preview window a countdown appears when the event is about to begin.

<Image title="vodCountdown.png" alt={426} align="center" src="https://files.readme.io/6c4edd9-vodCountdown.png">
  A countdown appears when the broadcast is about to begin
</Image>
...
<Image title="vodEventStatus.png" alt=" " align="center" src="https://files.readme.io/8d3442b-vodEventStatus.png" />

[Polls, chat, and Q\&A](doc:controlling-attendee-engagement) functions are available (if configured during set up).

<Image title="vodAttendeeEngage.png" alt=" " align="center" src="https://files.readme.io/1027131-vodAttendeeEngage.png" />
...
<Image title="hostManualControl.png" alt=" " align="center" src="https://files.readme.io/13aabb2-hostManualControl.png" />
...
If the Broadcast has *started*, the **Pause Broadcast** button is shown instead and the status banner displays: "Attendees can see the event. You are broadcasting the video on demand file to your audience". You are also able to click the **End Event** button when you are ready.
