...
[block:html]
{
  "html": "<iframe  width=\"640\" height=\"360\" src=\"https://vision.rev.vbrick.com/embed?id=34cff193-d29e-4acd-9cda-36c069b40350\" allowfullscreen style=\"\" frameborder=\"\"></iframe>"
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/aa0e94d-startProducerWebcast.png",
        "startProducerWebcast.png",
        "Any Producer may click the Start Webcast button"
      ],
      "align": "center",
      "caption": "Any Producer may click the Start Webcast button"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/716da77-goBackstage.png",
        null,
        "Use the controls under the image to select your screen, your camera or your audio, and then select **Go Backstage**"
      ],
      "align": "center",
      "caption": "Use the controls under the image to select your screen, your camera or your audio, and then select **Go Backstage**"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/910f8c4-accessEventDetails.png",
        "accessEventDetails.png",
        459
      ],
      "align": "center",
      "caption": "Click the Event Details icon to access the Edit Settings button to modify the Producer event settings during the event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6a93bb9-editEventDetails.png",
        "editEventDetails.png",
        499
      ],
      "align": "center",
      "caption": "Expand the section you want to edit by clicking the + icon.  Make sure you Save your edit."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1d3fbef-uiOverview.png",
        "uiOverview.png",
        1165
      ],
      "align": "center",
      "caption": "The **Producer Environment** includes the Staging, Scenes, and Backstage rows.  The flyout, with Design controls, is available only to **Producers**."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/178023d-stagingRow.png",
        null,
        "Stage your scene in the Preview window and then \"push\" it to the Onstage window to present it to attendees"
      ],
      "align": "center",
      "caption": "Stage your scene in the Preview window and then \"push\" it to the Onstage window to present it to attendees"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fe8e878-pushToLive.png",
        "pushToLive.png",
        "The double arrow is the \"Send Live\" button. It will move your Preview configuration to Onstage."
      ],
      "align": "center",
      "caption": "The double arrow is the \"Send Live\" button. It will move your Preview configuration to Onstage."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e5deb22-personalAudioControls.png",
        null,
        "Click the Speaker icon to use Onstage and Backstage audio controls"
      ],
      "align": "center",
      "caption": "Click the Speaker icon to use Onstage and Backstage audio controls"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/726598a-pushToTalkControl.png",
        null,
        "Click the three-dot control for specific audio options for that specific person"
      ],
      "align": "center",
      "caption": "A Producer (only) can click and hold the push-to-talk control for a specific participant Onstage to speak directly to them"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d8fc95d-scenesRow.png",
        "scenesRow.png",
        1864
      ],
      "align": "center",
      "caption": "Need to return to a particular scene?  Click on the scene in this row and back you go."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ce19842-backstageRow.png",
        null,
      ...
      "align": "center",
      "caption": "All collaborators in the webcast are in this row where they are dragged to the Preview window by Producers to create Scenes"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/89eb4ea-productionDesignIcon.png",
        "productionDesignIcon.png",
        65
      ],
      "align": "center",
      "caption": "Toggle layout and branding options"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/79f329a-layoutOptions.png",
        "layoutOptions.png",
        " "
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fdd5618-backgroundOptions.png",
        "backgroundOptions.png",
        461
      ],
      "align": "center",
      "caption": "Select a pre-existing background or upload a custom background"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/40c9027-brandingOptions.png",
        "brandingOptions.png",
        " "
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7262661-addStreamBackground.png",
        null,
        "Click Add Screen as Background on a streaming video to set it as the Producer Onstage background"
      ],
      "align": "center",
      "caption": "Click Add Screen as Background on a streaming video to set it as the Producer Onstage background"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5bbf910-streamingBackground.png",
        "streamingBackground.png",
        " "
      ],
      "align": "center"
    }
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1db1dce-townhallAttendeeView.png",
        "townhallAttendeeView.png",
        1449
      ],
      "align": "center",
      "caption": "Branding options applied on a Townhall layout - Attendee's view"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/31ee4b6-panelLayoutSelected.png",
        "panelLayoutSelected.png",
        491
      ],
      "align": "center",
      "caption": "Selecting a layout option places it in the Preview window on the Staging Row"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6d8eb5a-panelLayoutPreview.png",
        "panelLayoutPreview.png",
        1356
      ],
      "align": "center",
      "caption": "The selected layout is blank until it is filled with Backstage members"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cc85bb9-panelLayoutPreviewComplete.png",
        "panelLayoutPreviewComplete.png",
        800
      ],
      "align": "center",
      "caption": "Complete the Preview window by clicking and dragging options from the Backstage Row"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4889c40-panelAttendeeView.png",
        "panelAttendeeView.png",
        1386
      ],
      "align": "center",
      "caption": "The Attendee view of a Panel layout"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c41b228-backstageCount.png",
        null,
        "Easily track who is supposed to be present before you begin Broadcasting"
      ],
      "align": "center",
      "caption": "Easily track who is supposed to be present before you begin Broadcasting"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2e25392-speakerIcons.png",
        "speakerIcons.png",
        800
      ],
      "align": "center",
      "caption": "You are able to see at a glance what Speakers are going to be Live next"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c78810b-speakerDotMenu.png",
        "speakerDotMenu.png",
        222
      ],
      "align": "center",
      "caption": "You can add different Speaker options to the Preview window"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/fffb787-mutedSpeaker.png",
        "mutedSpeaker.png",
        " "
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/52a8c7e-onstageBroadcasting.png",
        "onstageBroadcasting.png",
        1448
      ],
      "align": "center",
      "caption": "You are told if the Onstage window is broadcasting"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/196c6e1-speakerQue.png",
        "speakerQue.png",
        " "
      ],
      "align": "center"
