...
![If embedding is enabled, use the Embed tab to access the embed code snippet to embed your Rev webcasts](https://files.readme.io/74f5008-embedTab.png)
...
![Select the size you want and then click the Copy button to copy the embed code](https://files.readme.io/8a54157-embedWebcast.png)
