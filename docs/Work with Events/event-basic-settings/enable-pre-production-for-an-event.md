---
title: Enable Pre-Production for an Event
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
Enable the **Pre-Production** tab in the **Basic Settings** section during event set up if you want to conduct one or more test runs (dry runs) of your event _prior_ to the scheduled start time of the main (production) event. 
...
The [Prepare a Dry Run](doc:prepare-a-dry-run-event) topic demonstrates the steps for a Host on running a dry run of your event before you host the Main event.