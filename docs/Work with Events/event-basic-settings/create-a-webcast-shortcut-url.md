---
title: Create a Webcast Shortcut URL
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
The **Webcast Shortcut** field in the **Event Basic Settings** section is used to create a friendly custom URL for the webcast that is easy for attendees to remember. 
...
<Image title="webcastShortcut.png" alt={945} align="center" src="https://files.readme.io/ab766ed-webcastShortcut.png">
...
<Image title="selectEventLink.png" alt={734} align="center" src="https://files.readme.io/4c4d35c-selectEventLink.png">
...
## Display or Hide the Webcast URL During the Broadcast

If you choose to create a Webcast shortcut URL, you can also choose whether to hide or display it when you begin broadcasting. The **Show Event Sharing Link** option in **Basic Settings**  enables or disables the **webcast sharing URL** on the [Event Details](doc:webcast-attendee-features#view-webcast-details) page while the webcast is broadcasting.  Note that this setting is enabled by default which means that the shortcut you create is displayed.

<Image title="showEventSharingLink.png" alt={612} align="center" src="https://files.readme.io/08a9a89-showEventSharingLink.png">
