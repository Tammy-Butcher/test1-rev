...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5a34432-producerVideoSource.png",
        "producerVideoSource.png",
        1152,
        258,
        "#000000"
      ],
      "caption": "Select Producer as a Video Source to create a Producer event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a89f552-eventHosts.png",
        "eventHosts.png",
        1272,
        639,
        "#000000"
      ],
      "caption": "At least one Producer must be designated.  These Producers are Hosts with additional capabilities and responsibilities with controlling a Producer event."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5f8fb80-eventPresentersInternal.png",
        "eventPresentersInternal.png",
        1147,
        608,
        "#000000"
      ],
      "caption": "Internal Event Presenters are Rev Account holders and must be logged in to attend the event"
    }
  ]
}
[/block]
...
[block:callout]
{
  "type": "info",
  "title": "Note",
  "body": "The External Event Presenters feature must be enabled in [Producer Settings](doc:producer-settings) by an Account Admin before it is visible."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d8b54d0-externalEventPresenter.png",
        "externalEventPresenter.png",
        1112,
        150,
        "#000000"
      ],
      "caption": "External Event Presenters are Guest presenters and are only required to have a valid email address for invite purposes."
    }
  ]
}
[/block]
...
* **Presenters** (Internal or External) can *only* control their *own* webcam and screen share (unlike Producers).  
...
[block:callout]
{
  "type": "warning",
  "title": "Important!",
  "body": "A total of up to nine unique Producers and Presenters (no matter the type) can be selected for the event."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d5cc50b-addBackgroundImage.png",
        "addBackgroundImage.png",
        1144,
        326,
        "#000000"
      ],
      "caption": "Add a custom background image for your event in Producer Settings"
    }
  ]
}
[/block]
...
The following settings are *disabled* and/or hidden with **Producer** events:
