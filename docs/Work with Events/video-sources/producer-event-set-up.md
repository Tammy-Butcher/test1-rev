...
<Image title="producerVideoSource.png" alt={1152} src="https://files.readme.io/5a34432-producerVideoSource.png">
  Select Producer as a Video Source to create a Producer event
</Image>
...
<Image title="eventHosts.png" alt={1272} src="https://files.readme.io/a89f552-eventHosts.png">
  At least one Producer must be designated.  These Producers are Hosts with additional capabilities and responsibilities with controlling a Producer event.
</Image>
...
<Image title="eventPresentersInternal.png" alt={1147} src="https://files.readme.io/5f8fb80-eventPresentersInternal.png">
  Internal Event Presenters are Rev Account holders and must be logged in to attend the event
</Image>
...
> 📘 Note
>
> The External Event Presenters feature must be enabled in [Producer Settings](doc:producer-settings) by an Account Admin before it is visible.

<Image title="externalEventPresenter.png" alt={1112} src="https://files.readme.io/d8b54d0-externalEventPresenter.png">
  External Event Presenters are Guest presenters and are only required to have a valid email address for invite purposes.
</Image>
...
<Image title="addBackgroundImage.png" alt={1144} src="https://files.readme.io/d5cc50b-addBackgroundImage.png">
  Add a custom background image for your event in Producer Settings
</Image>
