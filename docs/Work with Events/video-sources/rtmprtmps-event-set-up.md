...
> 🚧 Important!
>
> Note that Rev also starts the **cloud listener** for the Push URL at the event **Start time**. This means that the listener is *not* available (or even IP resolvable) *before* the event begins. 
>
...
![902](https://files.readme.io/23686cc-rtmpWebcast.png "rtmpWebcast.png")
...
> 👍 Use Case Example
>
> A big use case is the employing the Vbrick encoder or an external RTMP source to supply the video of your event. Our 9000 Encoders work very well for this use case, and are integrated into the stop/start processes of event. 
>
