...
next:
  description: ''
---
A **Webcam and Screenshare** source is an event that allows you to quickly start and stream a webcast  _without_ the need for any additional 3rd party hardware or software set up. Instead, utilizing [WebRTC](https://en.wikipedia.org/wiki/WebRTC) technologies, a **Presenter** is able to use their own internal or USB webcam, microphone, and browser or screenshare with audio to broadcast an event.
...
<Image align="center" alt={1805} border={false} caption="Choose Webcam and Screenshare as your Video Source if you want to self produce your event" title="selfProducedSource.png" src="https://files.readme.io/4f8e65d-selfProducedSource.png" />
...
<Image align="center" alt={1151} border={false} caption="The Presenter defaults to the person who creates the event" title="hostPresenterModerator.png" src="https://files.readme.io/d1a36c2-hostPresenterModerator.png" />
...
**Webcast and Screenshare** events The following settings are _disabled_ and/or hidden with webcam and screenshare events:
...
> 📘 Note
>
> This feature must be globally enabled by an Account Admin under [Additional Video Sources](<doc:This setting must be enabled for this feature to be used otherwise it will not be visible in the drop-down.>) in **Integrations** before it is visible.
