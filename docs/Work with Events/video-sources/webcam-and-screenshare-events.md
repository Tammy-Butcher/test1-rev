...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4f8e65d-selfProducedSource.png",
        "selfProducedSource.png",
        1805
      ],
      "align": "center",
      "caption": "Choose Webcam and Screenshare as your Video Source if you want to self produce your event"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d1a36c2-hostPresenterModerator.png",
        "hostPresenterModerator.png",
        1151
      ],
      "align": "center",
      "caption": "The Presenter defaults to the person who creates the event"
    }
  ]
}
[/block]
