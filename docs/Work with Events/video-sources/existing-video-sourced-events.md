...
<Image alt={1809} border={false} caption="Select Existing Video in the Video Source dropdown to rebroadcast a previously recorded video" title="preRecordedVideo.png" src="https://files.readme.io/433dfa3-preRecordedVideo.png" />
...
The following event settings are _disabled_ and hidden and may not be used when using an Existing Video as the webcast video source:
...
<Image alt={1495} border={false} caption="To choose a different Existing Video, delete the previously selected VOD first to replace it" title="deletePreRecordedVideo.png" src="https://files.readme.io/0b4bf8d-deletePreRecordedVideo.png" />
...
<Image alt={1499} border={false} caption="Be aware of your video length versus your event duration!" title="videoTimeError.png" src="https://files.readme.io/be744ae-videoTimeError.png" />
